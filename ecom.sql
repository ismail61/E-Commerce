...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 09, 2021 at 12:13 PM
...
INSERT INTO `admins` (`admin_id`, `admin_name`, `admin_email`, `admin_password`, `admin_image`, `admin_phone`, `admin_job`, `admin_about`, `admin_address`, `otp`) VALUES
(1, 'Ismail hosen Raj', 'ismailhosen601@gmail.com', '12345', 'khihh.jpg', 1770964628, 'CEO', 'Nothing to say anything because every thing is fair in love', 'Rajshahi', 14502),
(2, 'Hosen', 'hosen@gmail.com', '12345', 'my.jpg', 1841602207, 'Administrator', 'I am all in one', 'Dhaka', NULL);
...
INSERT INTO `boxes` (`box_id`, `box_title`, `box_description`, `box_url`) VALUES
(1, 'BEST PRICES', 'You can check on all other sites about the prices and than compare with us.', 'http://localhost/Ecom/shop.php'),
(3, ' 100% SATISFACTION GUARANTEED', 'Free return on everything for 15 days', 'http://localhost/Ecom/contact.php'),
(4, 'WE LOVE OUR CUSTOMERS', 'We are known to provide best possible services', 'http://localhost/Ecom/customer_register.php');
...
INSERT INTO `contacts` (`ip_address`, `name`, `email`, `subject`, `message`) VALUES
(NULL, 'Ismail', 'ismail61@gmail.com', 'NICe', 'your website is beauty'),
('::1', 'Ismail', 'ismail@gmial.com', 'NICe', 'nice website'),
('::1', 'Ismail', 'ismail6@gmial.com', 'NICe', 'hh'),
('::1', 'MD ismail Hosen Raj', 'ismailhosen601@gmail.com', 'PHP', 'sesseon expire');
...
INSERT INTO `customer` (`customer_id`, `customer_name`, `customer_email`, `customer_phone`, `customer_username`, `customer_password`, `customer_division`, `customer_district`, `customer_thana`, `customer_address`, `customer_image`, `customer_ip_address`, `customer_shipping_address`, `status_`) VALUES
(3, 'Md Ismail Hosen Siraji', 'ismailhosen601@gmail.com', 1770964628, 'lose61', 'ismail6', 'Rajshahi', 'Chapai NawabGonj', 'Shibgonj', 'Shobgonj Bazar,Shibgonj,Chapai NawabGonj', 'khihh.jpg', '127.0.0.1', NULL, 1),
(7, 'Ismail Hosen Raj', 'lab@gmail.com', 1315898789, 'labu', 'ismail61', 'Rajshahi', 'Rajshahi', 'Rajshahi', 'Rajshahi,Shibgonj Bazar,Shibgonj,\r\nChapai NawabGonj,Rajshahi', 'large.png', '127.0.0.1', 'JalmachMary ,Shibgonj Bazar,Shibgonj,\r\nChapai NawabGonj,Rajshahi', 1),
(8, 'Ismail hosen Dipannita', 'l@gmail.com', 1744753977, 'dipannita61', 'dipannita', 'Rajshahi', 'Rajshahi', 'Rajshahi', 'Shobgonj Bazar,Shibgonj, Chapai NawabGonj Rajshahi', 'large - Copy.png', '127.0.0.1', NULL, 1),
(9, 'lam', 'ismail@gmail.com', 18828282, 'hosen', '23456', 'Dhaka', 'dhaka', 'uttara', 'sector 10 , uttara ', 'large.png', '::1', NULL, 1),
(10, 'lam', 'ismail@gmail.com', 18828282, 'hosen666', '454646', 'Dhaka', 'dhaka', 'uttara', 'sector 10 , uttara ', 'large.png', '::1', NULL, 1),
(11, 'lam', 'ismail@gmail.com', 18828282, 'hosen6667', '89808', 'Dhaka', 'dhaka', 'uttara', 'sector 10 , uttara ', 'large.png', '::1', NULL, 1),
(12, 'lam', 'ismail@gmail.com', 18828282, 'hosen66', '67675', 'Dhaka', 'dhaka', 'uttara', 'sector 10 , uttara ', 'large.png', '::1', NULL, 1),
(13, 'lamha', 'ismailll@gmail.com', 1882828277, 'hosen61@', '909090', 'Dhaka', 'dhaka', 'uttara', 'sector 10 , uttara ', 'large.png', '::1', NULL, 1);
...
(20, 3, 2580, 1671533381, 1, 'Black', '2021-02-09 11:25:14', 'pending', 23),
(21, 3, 27070, 293633148, 1, 'Mystic Black', '2021-02-09 12:10:33', 'Paid', 13),
(16, 3, 19990, 915786993, 1, 'Mystic Black', '2021-01-08 17:50:26', 'pending', 9),
(15, 7, 139999, 893271949, 1, 'Space Gray', '2020-07-07 06:45:50', 'pending', 7),
(17, 3, 26990, 396974786, 1, 'Mystic Black', '2021-01-08 18:00:31', 'COD', 14),
(18, 13, 2500, 978778143, 1, 'Black', '2021-01-10 19:29:44', 'pending', 23),
(19, 13, 22050, 1808418937, 1, 'Sweater Blue', '2021-01-10 19:36:05', 'pending', 22);
...
(1, '', '', '', 2500, '', 'Pending', 'SSLCZ_TEST_5ff88fcf176eb', 'BDT'),
(2, 'Md Ismail Hosen Siraji', 'ismail601@gmail.com', '1770964628', 2500, 'Shobgonj Bazar,Shibgonj,Chapai NawabGonj', 'Processing', 'SSLCZ_TEST_5ff8902e7174b', 'BDT'),
(3, 'Md Ismail Hosen Siraji', 'ismail601@gmail.com', '1770964628', 21990, 'Shobgonj Bazar,Shibgonj,Chapai NawabGonj', 'Processing', 'SSLCZ_TEST_5ff8952381c3c', 'BDT'),
(4, 'Md Ismail Hosen Siraji', 'ismail601@gmail.com', '1770964628', 17990, 'Shobgonj Bazar,Shibgonj,Chapai NawabGonj', 'Processing', 'SSLCZ_TEST_5ff8988212f60', 'BDT'),
(5, 'Md Ismail Hosen Siraji', 'ismail601@gmail.com', '1770964628', 10990, 'Shobgonj Bazar,Shibgonj,Chapai NawabGonj', 'Processing', 'SSLCZ_TEST_5ff899ef3a2f1', 'BDT');
...
(13, 3, 915786993, 9, 1, 'Mystic Black', 'pending'),
(14, 3, 396974786, 14, 1, 'Mystic Black', 'COD'),
(15, 13, 978778143, 23, 1, 'Black', 'pending'),
(16, 13, 1808418937, 22, 1, 'Sweater Blue', 'pending'),
(17, 3, 1671533381, 23, 1, 'Black', 'pending'),
(18, 3, 293633148, 13, 1, 'Mystic Black', 'Paid');
...
INSERT INTO `slider` (`id`, `slider_name`, `slider_url`, `slider_image`) VALUES
(12, 'Slider Number 12', 'http://localhost/Ecom/details.php?p_id=12', 'image_4.jpg'),
(10, 'Slider Number 10', 'http://localhost/Ecom/shop.php', 'image_3.jpg'),
(9, 'Slider Number 9', 'http://localhost/Ecom/details.php?p_id=17', 'image_1.jpg'),
(11, 'Slider Number 11', 'http://localhost/Ecom/details.php?p_id=22', 'image_2.jpg');
